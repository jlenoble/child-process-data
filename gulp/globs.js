...
export const gulpfileDir = path.join(testDir, 'gulpfiles');

export const apps = ['child-process-data'];
...
export const gulpGlob = join(gulpfileDir, '**/*.js');
...
export const testBundleRootGlob = join(buildDir, testDir, 'child-process-data.test.js');

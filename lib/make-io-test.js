    ...
    opts.checkResults = function (results) {
      ...
      .then(function () {
        return new Promise(function (resolve, reject) {
          var i = 0;
          var stdin = _this.childProcess.stdin;

          var check = function check(scheme) {
            if (scheme === 'io' || scheme === 'ie') {
              (0, _chai.expect)(results.outMessages).to.eql(outs);
              (0, _chai.expect)(results.errMessages).to.eql(errs);
            }
          };

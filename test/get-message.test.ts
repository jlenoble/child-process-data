...
//   resolveMessage,
//   clearMessages
// } from "../src/get-message";
// import { Options } from "../src/options";
// import { spawn } from "child_process";
// import { expect } from "chai";
// import Muter, { captured } from "muter";
//
// describe("Testing interceptMessage & resolveMessage", function(): void {
//   this.timeout(20000); // eslint-disable-line no-invalid-this
//
//   const echo = (msg: string, options: Options): Promise<void> => {
//     return interceptMessage(spawn("echo", [msg]), msg, options);
//   };
//
//   const muter = new Muter(console); // eslint-disable-line new-cap
//
//   beforeEach(clearMessages);
//   afterEach(clearMessages);
//
//   it(
//     `Capturing several echo processes`,
//     captured(muter, () => {
//       return Promise.all(
...
//   it(
//     `Testing 3 resolvers resolving the same message`,
//     captured(muter, () => {
//       return Promise.all(
//         ["message 1", "message 2", "message 3"].map(msg => {
//           return echo(msg).then(() => msg);
...
//
//   it(
//     `Resolvers can be started any time`,
//     captured(muter, () => {
